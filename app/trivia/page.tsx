  ...
  return (
    <div className="flex min-h-dvh flex-col bg-[radial-gradient(circle_at_top_left,rgba(220,38,38,0.12),transparent_32%),linear-gradient(180deg,#fff,#f7f7f8)]">
      ...
      <main className="flex-1">
        <div className="container-prose max-w-5xl space-y-6 py-5 md:space-y-8 md:py-12">
          <header className="relative overflow-hidden rounded-[1.5rem] bg-secondary px-5 py-8 text-center text-secondary-foreground shadow-xl md:rounded-[2rem] md:px-10 md:py-14">
