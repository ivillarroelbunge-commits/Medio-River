...
export const squadVerifiedAt = "11 de septiembre de 2026"
...
export const squadPlayers: SquadPlayer[] = [
  ...
  { id: "player-rivero", name: "Lautaro Rivero", number: 13, line: "Defensores", position: "Defensor central, Lateral izquierdo", age: 22, nationality: "Argentina", foot: "Zurdo", fromAcademy: true, image: fotmobPlayerImage(1649321) },
  ...
  { id: "player-facundo-gonzalez", name: "Facundo González", number: 31, line: "Defensores", position: "Defensor central, Lateral izquierdo", age: 20, nationality: "Argentina", foot: "Zurdo", fromAcademy: true, image: fotmobPlayerImage(1610373) },

  { id: "player-portillo", name: "Juan Portillo", number: 5, line: "Mediocampistas", position: "Volante central, Defensor central", age: 26, nationality: "Argentina", foot: "Diestro", fromAcademy: false, image: fotmobPlayerImage(1201814) },
  ...
  { id: "player-mauro-arambarri", name: "Mauro Arambarri", number: 8, line: "Mediocampistas", position: "Volante mixto", age: 30, nationality: "Uruguay", foot: "Diestro", fromAcademy: false, image: fotmobPlayerImage(625340) },
  ...
  { id: "player-juan-cruz-meza", name: "Juan Cruz Meza", number: 24, line: "Mediocampistas", position: "Volante mixto", age: 18, nationality: "Argentina", foot: "Diestro", fromAcademy: true, image: fotmobPlayerImage(1783664) },
  { id: "player-galvan", name: "Tomás Galván", number: 26, line: "Mediocampistas", position: "Volante mixto", age: 26, nationality: "Argentina", foot: "Zurdo", fromAcademy: true, image: fotmobPlayerImage(1256242) },
  ...
  { id: "player-tobias-andrada", name: "Tobías Andrada", number: 50, line: "Mediocampistas", position: "Volante mixto", age: 19, nationality: "Argentina", foot: "Diestro", fromAcademy: false, image: fotmobPlayerImage(1761527) },
  { id: "player-lautaro-pereyra", name: "Lautaro Pereyra", number: 25, line: "Mediocampistas", position: "Volante ofensivo", age: 18, nationality: "Argentina", foot: "Diestro", fromAcademy: true, image: fotmobPlayerImage(1946519) },
  ...
  { id: "player-lucas-beltran", name: "Lucas Beltrán", number: 18, line: "Delanteros", position: "Delantero", age: 25, nationality: "Argentina", foot: "Diestro", fromAcademy: true, image: fotmobPlayerImage(974755) },
  { id: "player-rafael-borre", name: "Rafael Borré", number: 19, line: "Delanteros", position: "Delantero", age: 30, nationality: "Colombia", foot: "Diestro", fromAcademy: false, image: fotmobPlayerImage(533775) },
  { id: "player-ruberto", name: "Agustín Ruberto", number: 32, line: "Delanteros", position: "Delantero", age: 20, nationality: "Argentina", foot: "Diestro", fromAcademy: true, image: fotmobPlayerImage(1580546) },
]
