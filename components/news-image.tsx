      ...
      <div className={cn("relative overflow-hidden bg-white", className)}>
        ...
        <div className="relative grid h-full w-full grid-cols-2 items-center">
          <div className="flex h-full items-center justify-center px-5">
            <img src={getTeamCrest(homeTeam)} alt={homeTeam} loading={priority ? "eager" : "lazy"} fetchPriority={priority ? "high" : "auto"} className={cn("max-h-[62%] max-w-[68%] object-contain", imageClassName)} />
          </div>
          <div className="flex h-full items-center justify-center px-5">
            <img src={getTeamCrest(awayTeam)} alt={awayTeam} loading={priority ? "eager" : "lazy"} fetchPriority={priority ? "high" : "auto"} className={cn("max-h-[62%] max-w-[68%] object-contain", imageClassName)} />
          </div>
        </div>
      </div>
    )
