...
export function NoticiasPageClient({
  ...
  const categories = useMemo(
    () => ["Todas", ...mergeNewsOptions(defaultCategories, optionSource.map((article) => article.category))],
    [optionSource],
  )
  const competitions = useMemo(
    () => ["Todas", ...mergeNewsOptions(defaultCompetitions, optionSource.map((article) => article.competition))],
    [optionSource],
  )
  ...
  }), [category, competition, featuredIds, listingNews, query, tag])
